...
void MainWindow::initConnections()
{
    ...
    connect(m_pCheckBoxAudioShare, &QCheckBox::toggled, this, &MainWindow::on_m_pCheckBoxAudioShare_toggled);
}
...
void MainWindow::on_m_pCheckBoxAudioShare_toggled(bool checked)
{
    if (checked) {
        QString scriptPath = QDir::cleanPath(QCoreApplication::applicationDirPath() + "/../../../../audio-prototype/gui/audio_gui.py");
#if defined(Q_OS_WIN)
